...
private Collection $conges;
    ...
    #[ORM\OneToOne(mappedBy: 'user', targetEntity: ContratEmploye::class, cascade: ['persist', 'remove'])]
private ?ContratEmploye $contratEmploye = null;

public function getContratEmploye(): ?ContratEmploye
{
    return $this->contratEmploye;
}

public function setContratEmploye(?ContratEmploye $contratEmploye): static
{
    $this->contratEmploye = $contratEmploye;

    // Assure la relation bidirectionnelle
    if ($contratEmploye && $contratEmploye->getUser() !== $this) {
        $contratEmploye->setUser($this);
    }
...
{
    return $this->contratEmploye !== null;
}
