...
/*//recherche d'un employé par ajax selon nom de l'employé
#[Route('/search-employe', name: 'search_employe', methods: ['GET'])]
public function searchEmploye(Request $request, ContratEmployeRepository $contratRepository): Response
{
    $term = $request->query->get('term');
    ...
    return $this->render('back_office/Contrats/searchemploye.html.twig', [
        'contrats' => $contrats,
    ]);
}*/
